...
<div class="modalform fade" id="chatform" tabindex="-1" role="dialog"  aria-hidden="true" >
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-body">
      <br>
      <br>
    <button type="button" data-toggle="modal" data-target="#666">Group 666E Chat</button> <br><br>
...
<div class="modal-header" style="background-color: black;">
<h3 style="color: white;">666E Group Members</h3>
...
$list= "SELECT * FROM `users` WHERE `Group_by`='666E'";
...
<div class="modal fade" id="666" role="dialog" tabindex="-1" aria-hidden="true" data-dismiss="chatform">
<div class="modal-dialog modal-dialog-scrollable" role="document" style="width:80%;">
<form id="form" class="modal-content" action="" method="POST">
        <div class="modal-header" style="background-color: black;">
        <h4 class="modal-title" style="color: white;">Chat 666E</h4>
        </div>
        <div class="modal-body">
...
$sql="INSERT INTO `666posts`(`msg`, `name`, `Group_by`) VALUES ('$msg','$name','$group');";
...
<div style="float:right;">
<button type="button" class="btn btn-default" data-toggle="modal" data-target="#666"  data-dismiss="666" name="closeit" style="width:auto;">Close</button></div>
