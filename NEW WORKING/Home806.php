...
<div class="modalform fade" id="chatform" tabindex="-1" role="dialog"  aria-hidden="true" >
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-body">
      <br>
      <br>
    <button type="button" data-toggle="modal" data-target="#806">Group 806G Chat</button> <br><br>
...
<div class="modal-header" style="background-color: black;">
<h3 style="color: white;">806G Group Members</h3>
...
$list= "SELECT * FROM `users` WHERE `Group_by`='806G'";
...
<div class="modal fade" id="806" role="dialog" tabindex="-1" aria-hidden="true" data-dismiss="chatform">
<div class="modal-dialog modal-dialog-scrollable" role="document" style="width:80%;">
<form id="form" class="modal-content" action="" method="POST">
        <div class="modal-header" style="background-color: black;">
        <h4 class="modal-title" style="color: white;">Chat 806G</h4>
        </div>
        <div class="modal-body">
...
$sql="INSERT INTO `806posts`(`msg`, `name`, `Group_by`) VALUES ('$msg','$name','$group');";
...
<div style="float:right;">
<button type="button" class="btn btn-default" data-toggle="modal" data-target="#806"  data-dismiss="806" name="closeit" style="width:auto;">Close</button></div>
