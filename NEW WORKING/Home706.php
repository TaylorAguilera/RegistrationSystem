...
<div class="modalform fade" id="chatform" tabindex="-1" role="dialog"  aria-hidden="true" >
  <div class="modal-dialog" role="document">
    ...
    <div class="modal-body">
      <br>
      <br>
    <button type="button" data-toggle="modal" data-target="#706">Group 706F Chat</button> <br><br>
...
<div class="modal-header" style="background-color: black;">
<h3 style="color: white;">706F Group Members</h3>
...
$list= "SELECT * FROM `users` WHERE `Group_by`='706F'";
...
<div class="modal fade" id="706" role="dialog" tabindex="-1" aria-hidden="true" data-dismiss="chatform">
<div class="modal-dialog modal-dialog-scrollable" role="document" style="width:80%;">
<form id="form" class="modal-content" action="" method="POST">
        <div class="modal-header" style="background-color: black;">
        <h4 class="modal-title" style="color: white;">Chat 706F</h4>
        </div>
        <div class="modal-body">
...
$sql="INSERT INTO `706posts`(`msg`, `name`, `Group_by`) VALUES ('$msg','$name','$group');";
...
<div style="float:right;">
<button type="button" class="btn btn-default" data-toggle="modal" data-target="#706"  data-dismiss="706" name="closeit" style="width:auto;">Close</button></div>
